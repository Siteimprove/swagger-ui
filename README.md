...
**This is the Siteimprove fork of Swagger UI that addresses A11Y issues that were impacting [Siteimprove API Documentation](https://api.siteimprove.com/v2/documentation), it is NOT a comprehensive fix for all accessibility issues present in Swagger UI.**
